...
def saveScreenshot(datapath, dataname, ratio, outputname):
    ...
    tempLUT.RGBPoints = [2.5942752154014084, 0.23137254902, 0.298039215686, 0.752941176471, 1905156.953661135, 0.865, 0.865, 0.865, 1399089424489.521, 0.705882352941, 0.0156862745098, 0.149019607843]
...
if __name__ == "__main__":
    ...
    for r in ratio:
        outputname = "./hacc_temp_cool2warm_global_{}.png".format(r)
