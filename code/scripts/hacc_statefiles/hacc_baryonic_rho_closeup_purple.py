...
def saveScreenshot(datapath, dataname, ratio, outputname):
    ...
    renderView1.CameraPosition = [295.27176571775726, 313.82655393576226, 346.7958930281535]
    renderView1.CameraFocalPoint = [106.04590703926189, 101.5919494811348, 88.0963861319136]
    renderView1.CameraViewUp = [-0.40824829046386296, 0.8164965809277263, -0.40824829046386285]
    renderView1.CameraViewAngle = 1.727625
...
if __name__ == "__main__":
    ...
    for r in ratio:
        outputname = "./hacc_rho_purple_closeup_{}.png".format(r)
