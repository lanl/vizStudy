...
def saveScreenshot(datapath, dataname, ratio, outputname):
    ...
    renderView1.CameraFocalPoint = [104.5672699765958, 99.39191169701934, 86.78995150965734]
    renderView1.CameraViewUp = [-0.40824829046386296, 0.8164965809277263, -0.40824829046386285]
    renderView1.CameraViewAngle = 3.1875
...
if __name__ == "__main__":
    ...
    for r in ratio:
        outputname = "./hacc_temp_cool2warme_closeup_{}.png".format(r)
