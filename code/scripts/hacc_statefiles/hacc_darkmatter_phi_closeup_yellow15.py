...
def saveScreenshot(datapath, dataname, ratio, outputname):
    ...
    renderView1.CameraPosition = [235.52373667848485, 244.5264099872407, 263.44472900705205]
    renderView1.CameraFocalPoint = [105.51418093395286, 99.86539667555233, 87.9950227014385]
    renderView1.CameraViewUp = [-0.40824829046386296, 0.8164965809277263, -0.40824829046386285]
    renderView1.CameraViewAngle = 1.6770937499999996
    ...
    phi_pLUT.RGBPoints = [2.0, 1.0, 1.0, 0.988235, 7359.692906250003, 1.0, 1.0, 0.988235, 183944.3226562501, 0.984314, 0.988235, 0.843137, 367886.6453125002, 0.988235, 0.988235, 0.741176, 551828.9679687502, 0.980392, 0.968627, 0.654902, 735771.2906250004, 0.980392, 0.945098, 0.576471, 919713.6132812503, 0.968627, 0.905882, 0.486275, 1103655.9359375003, 0.968627, 0.862745, 0.388235, 1287598.2585937504, 0.960784, 0.803922, 0.286275, 1471540.5812500007, 0.94902, 0.741176, 0.219608, 1655482.9039062506, 0.941176, 0.678431, 0.14902, 1839425.2265625007, 0.929412, 0.607843, 0.094118, 2023367.549218751, 0.921569, 0.545098, 0.054902, 2207309.8718750007, 0.909804, 0.486275, 0.035294, 2391252.194531251, 0.890196, 0.411765, 0.019608, 2575194.517187501, 0.8, 0.305882, 0.0, 2759136.839843751, 0.760784, 0.239216, 0.0, 2943079.1625000015, 0.678431, 0.180392, 0.011765, 3127021.485156251, 0.6, 0.121569, 0.023529, 3310963.807812501, 0.501961, 0.054902, 0.031373, 3494906.1304687513, 0.4, 0.039216, 0.058824, 3678848.4531250014, 0.301961, 0.047059, 0.090196]
    ...
    phi_pPWF.Points = [2.0, 0.0, 0.5, 0.0, 3678848.453125, 1.0, 0.5, 0.0]
...
if __name__ == "__main__":
    ...
    for r in ratio:
        outputname = "./hacc_phi_yellow15_closeup_{}.png".format(r)
