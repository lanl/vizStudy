...
def saveScreenshot(inputFilename, regName, outputName):   
    ...
    native_fieldstemperatureLUT.RGBPoints = [0.0, 0.0, 0.0, 0.5625, 11111.100000000002, 0.0, 0.0, 1.0, 36507.95, 0.0, 1.0, 1.0, 49206.35, 0.5, 1.0, 0.5, 61904.75, 1.0, 1.0, 0.0, 87301.6, 1.0, 0.0, 0.0, 100000.0, 0.5, 0.0, 0.0]
    ...
    native_fieldstemperatureLUT.NanColor = [1.0, 0.0, 0.0]
