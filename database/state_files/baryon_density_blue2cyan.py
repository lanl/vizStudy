...
def saveScreenshot(inputFilename, regName, outputName):   
    ...
    native_fieldsbaryon_densityPWF.Points = [0.0, 0.0, 0.5, 0.0, 24.137929916381836, 0.866310179233551, 0.5, 0.0, 500.0, 1.0, 0.5, 0.0]
