...
def saveScreenshot(inputFilename, regName, outputName):   
    ...
    native_fieldsbaryon_densityLUT.RGBPoints = [0.06377197802066803, 0.23137254902, 0.298039215686, 0.752941176471, 250.03188598901033, 0.865, 0.865, 0.865, 500.0, 0.705882352941, 0.0156862745098, 0.149019607843]
    ...
    native_fieldsbaryon_densityPWF.Points = [0.06377197802066803, 0.0, 0.5, 0.0, 17.689727783203125, 0.9679144620895386, 0.5, 0.0, 500.0, 1.0, 0.5, 0.0]
