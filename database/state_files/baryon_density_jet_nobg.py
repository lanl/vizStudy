...
def saveScreenshot(inputFilename, regName, outputName):   
    ...
    native_fieldsbaryon_densityLUT.RGBPoints = [0.06377197802066803, 0.0, 0.0, 0.5625, 55.61218620977082, 0.0, 0.0, 1.0, 182.5802401361709, 0.0, 1.0, 1.0, 246.0641421153139, 0.5, 1.0, 0.5, 309.5480440944569, 1.0, 1.0, 0.0, 436.516098020857, 1.0, 0.0, 0.0, 500.0, 0.5, 0.0, 0.0]
