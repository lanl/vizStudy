...
def saveScreenshot(inputFilename, regName, outputName):   
    ...
    native_fieldsdark_matter_densityLUT.RGBPoints = [0.0, 0.0, 0.0, 0.5625, 55.55550000000001, 0.0, 0.0, 1.0, 182.53975, 0.0, 1.0, 1.0, 246.03175, 0.5, 1.0, 0.5, 309.52375, 1.0, 1.0, 0.0, 436.508, 1.0, 0.0, 0.0, 500.0, 0.5, 0.0, 0.0]
