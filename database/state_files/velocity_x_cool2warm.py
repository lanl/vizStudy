...
def saveScreenshot(inputFilename, regName, outputName):   
    ...
    native_fieldsvelocity_xLUT.RGBPoints = [-10000000.0, 0.23137254902, 0.298039215686, 0.752941176471, 0.0, 0.865, 0.865, 0.865, 10000000.0, 0.705882352941, 0.0156862745098, 0.149019607843]
    ...
    native_fieldsvelocity_xPWF.Points = [-10000000.0, 0.0, 0.5, 0.0, -8812500.0, 0.11025641113519669, 0.5, 0.0, -5500000.0, 0.3461538553237915, 0.5, 0.0, 10000000.0, 1.0, 0.5, 0.0]
